...
- Python tasks use `WORKBENCH_PYTHON`, `apps/ai/.venv`, an activated environment, or Python 3.14+ on PATH. Setup instructions are in `README.md`; do not make Conda a prerequisite for validation.
